...
import com.easy1staking.spectrum.swap.service.*;
...
@SpringBootTest(classes = {SpringBaseTest.TestConfig.class, HybridUtxoSupplier.class, NftPoolService.class, DataParser.class,
        StaticProtocolParamsSupplier.class})
@ActiveProfiles("test")
public class SpringBaseTest {
    ...
    static class TestConfig {
        ...
        @MockBean
        public LocalTxSubmissionClient localTxSubmissionClient;
        @MockBean
        public LocalTransactionProcessor localTransactionProcessor;
